    ...
    <div className="flex flex-col items-center justify-center min-w-96 max-auto">
        <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" placeholder="Samir" className="w-full input input-bordered h-10" value={inputs.fullName} onChange={(e) => setInputs({...inputs, fullName: e.target.value})}/>
                </div>
                ...
                <div>
                    ...
                    <input type="text" placeholder="samir" className="w-full input input-bordered h-10" value={inputs.username} onChange={(e) => setInputs({...inputs, username: e.target.value})}/>
                </div>
                ...
                <input type="password" placeholder="Confirme Password" className="w-full input input-bordered h-10" value={inputs.confirmePassword} onChange={(e) => setInputs({...inputs, confirmePassword: e.target.value})}/>
                </div>
